...
function agregar_bloque(){
    ...
    //transacciones.push({"ventas":transacciones});
    let ventrasTransaccion = [];
    ventrasTransaccion.push({"ventas":transacciones})
    bloques.agregar(JSON.stringify(ventrasTransaccion));
    transacciones=[];
